...
function Sub() {
    ...
    document.getElementById("C_r2c1").innerText = add[5]
    document.getElementById("C_r2c2").innerText = add[6]
    document.getElementById("C_r2c3").innerText = add[7]
    document.getElementById("C_r2c4").innerText = add[8]
    document.getElementById("C_r2c5").innerText = add[9]
    document.getElementById("C_r3c1").innerText = add[10]
    document.getElementById("C_r3c2").innerText = add[11]
    document.getElementById("C_r3c3").innerText = add[12]
    document.getElementById("C_r3c4").innerText = add[13]
    document.getElementById("C_r3c5").innerText = add[14]
    document.getElementById("C_r4c1").innerText = add[15]
    document.getElementById("C_r4c2").innerText = add[16]
    document.getElementById("C_r4c3").innerText = add[17]
    document.getElementById("C_r4c4").innerText = add[18]
    document.getElementById("C_r4c5").innerText = add[19]
